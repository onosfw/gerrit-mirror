...
[uninstalled] [4.0.2 ] wrapper           standard-4.0.2      Provide OS integration
[uninstalled] [4.0.2 ] obr               standard-4.0.2      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.2 ] config            standard-4.0.2      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.2 ] region            standard-4.0.2      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.2      Provide Jetty engine support
[uninstalled] [4.0.2 ] http              standard-4.0.2      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.2 ] http-whiteboard   standard-4.0.2      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.2 ] war               standard-4.0.2      Turn Karaf as a full WebContainer
[uninstalled] [4.0.2 ] deployers         standard-4.0.2      Provide Karaf deployer
[uninstalled] [4.0.2 ] kar               standard-4.0.2      Provide KAR (KARaf archive) support
[uninstalled] [4.0.2 ] webconsole-base   standard-4.0.2      Base support of the Karaf WebConsole
[uninstalled] [4.0.2 ] webconsole        standard-4.0.2      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.2 ] ssh               standard-4.0.2      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.2.war, and
